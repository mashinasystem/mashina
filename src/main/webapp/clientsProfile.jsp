    ...
    <div class="row">
        <div class="col-lg-6 portfolio-item">
            <div class="card h-100">
                <a href="/clients/orders"><img class="card-img-top" src="htp://placehold.it/700x400" alt=""></a>
                <div class="card-body">
                    <h4 class="card-title">
                        <a href="/clients/orders"><fmt:message key="label.orders"/></a>
                    </h4>
                    <p class="card-text">
        ...
        <div class="col-lg-6 portfolio-item">
            <div class="card h-100">
                <a href="/clients/info"><img class="card-img-top" src="htp://placehold.it/700x400" alt=""></a>
                <div class="card-body">
                    <h4 class="card-title">
                        <a href="/clients/info">
