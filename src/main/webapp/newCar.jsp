...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <h1 class="py-4"></h1>
            <h1 class="mt-4 mb-3"><fmt:message key="label.addCustomer"/>
                <small><fmt:message key="label.car"/></small>
            </h1>
            <form class="login-form" action="/admin/1/newcar" method="post">
                <div class="control-group form-group">
                    <div class="controls">
                        <input type="text" class="form-control" required="required" placeholder="model" name = "model"
                               required data-validation-required-message="Please fill this field.">
                    </div>
                </div>
                <div class="control-group form-group">
                    <div class="controls">
                        <input type="text" class="form-control" required="required" placeholder="number" name = "number"
                               required data-validation-required-message="Please fill this field.">
                    </div>
                </div>
                <div class="control-group form-group">
                    <div class="controls">
                        <input type="text" class="form-control" required="required" placeholder="marque" name = "marque"
                               required data-validation-required-message="Please fill this field.">
                    </div>
                </div>
                <div id="success"></div>
                <button type="submit" class="btn btn-dark" id="text" value="newcar">
